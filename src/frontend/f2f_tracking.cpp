                       ...
                       const bool use_gpu)
{
  ...
  this->feature_dem   = new FeatureDEM(dc_in.img_w,dc_in.img_h,feature_para, use_gpu);
  this->lkorb_tracker = new LKORBTracking(dc_in.img_w,dc_in.img_h, use_gpu);
  ...
  curr_frame->setGpu(use_gpu);
  last_frame->setGpu(use_gpu);
